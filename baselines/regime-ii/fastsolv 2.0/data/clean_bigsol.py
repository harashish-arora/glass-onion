...
# --- SOLVENT ALIAS MAP (Based on Krasnov/FastSolv) ---
SOLVENT_ALIASES = {
    "THF": "tetrahydrofuran",
    "n-heptane": "heptane",
...
def canonicalize_smiles(smiles):
    """
     ...
     As requested: No FragmentParent, keep the salt form, but 
     Krasnov rule (filtering for '.') will be applied separately.
    """
    try:
...
def convert_row_to_logs(row):
    """
    Consistent with the need for molarity (mol/L).
